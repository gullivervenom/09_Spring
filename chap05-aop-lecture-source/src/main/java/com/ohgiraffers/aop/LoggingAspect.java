...
public class LoggingAspect {
    ...
    *   실행 지점을 설정 하게 되면 우리가 메소드 내에 작성한 코드(Advice)를
    ...
    *   메소드명, 인수, 정보 등등을 가지고 있게 된다. */
    ...
    /* 같은 클래스 내에 PointCut 을 설정했다면 클래스명은 생략 가능
        만약 다른 클래스에 PointCut 을 설정했다면 클래스명은 풀 클래스명(패키지 포함)
        으로 작성해야 한다. */
    @After("logPointCut()")
