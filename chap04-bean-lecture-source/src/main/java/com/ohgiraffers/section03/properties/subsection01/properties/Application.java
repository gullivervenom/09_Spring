...
public class Application {
    public static void main(String[] args) {
        ...
        Product kimchi = context.getBean("kimchi", Product.class);
        ...
        *   가비지 컬렉터가 해당 빈을 메모리에서 삭제할 때 destroy 메소드가 동작을 하게 되는데
        *   메모리에서 지우기 전에 프로세스가 종료되기 때문에
        *   강제로 컨테이너를 닫아줘야 destroy 는 확인이 가능하다. */
